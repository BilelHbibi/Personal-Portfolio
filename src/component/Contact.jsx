...
const socialLinks = [
  {
    href: "https://github.com/BilelHbibi",
    icon: (
      <svg
        width="24"
        height="24"
  ...
  {
    href: "https://www.linkedin.com/in/bilel-habibi/",
    icon: (
      <svg
        width="24"
        height="24"
  ...
  {
    href: "https://www.instagram.com/bilelhabibi97/",
    icon: (
      <svg
        width="25"
        height="24"
        ...
        <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
          <div className="mb-12 lg:mb-0 lg:flex lg:flex-col">
            <h2 className="headline-2 lg:max-w-[12ch] reveal-up">
              {t.contactContent.contactTitle}
            </h2>
            <p className="text-zinc-400 mt-3 mb-8 max-w-[50ch] lg:max-w-[30ch] reveal-up">
            {t.contactContent.contactDescription}
            </p>
            ...
            <div className="flex items-center gap-2 mt-auto">
              {socialLinks.map(({ href, icon }, key) => (
                <a
                  ...
                  target="_blank"
                  key={key}
                  className="w-12 h-12 grid place-items-center ring-inset ring-2 rounded-lg ring-zinc-50/5 transition-[background-color,color] hover:bg-zinc-50 hover:text-zinc-950 active:bg-zinc-50/80 reveal-up"
                >
                  {icon}
                </a>
              ))}
          ...
          <form
            action="https://getform.io/f/akkyxkqa"
          ...
          >
            ...
            <div className="mb-4">
              ...
              {t.contactContent.messageLabel}
              </label>
              <textarea
                name="message"
                id="message"
                placeholder={t.contactContent.salut}
                required
